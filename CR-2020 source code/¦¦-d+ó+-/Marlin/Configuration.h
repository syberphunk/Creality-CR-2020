...
#define INVERT_X_DIR false//false  TMC-TRUE
#define INVERT_Y_DIR true//true  TMC-FALSE
#define INVERT_Z_DIR false//true  4988-FALSE

// @section extruder

// For direct drive extruder v9 set to true, for geared extruder set to false.
#define INVERT_E0_DIR true//false  4988-TRUE
...
// default settings
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.00,80.00,400.00,113}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 5, 250}    // (mm/sec)
...
#define FILAMENT_SENSOR_EXTRUDER_NUM 0   //The number of the extruder that has the filament sensor (0,1,2) 材料传感器
