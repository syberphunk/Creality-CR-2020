...
static const char* msg_filament_diam_diam_e1() {
  switch (currentfontnameindex) {
    ...
    case 1:
      return PSTR(CN_MSG_FILAMENT_DIAM CN_MSG_DIAM_E1);
    case 2:
      return PSTR(KANA_MSG_FILAMENT_DIAM KANA_MSG_DIAM_E1);    
  }
  return PSTR(MSG_FILAMENT_DIAM MSG_DIAM_E1);
}
...
static const char* msg_filament_diam_diam_e2() {
  switch (currentfontnameindex) {
    ...
    case 1:
      return PSTR(CN_MSG_FILAMENT_DIAM CN_MSG_DIAM_E2);
    case 2:
      return PSTR(KANA_MSG_FILAMENT_DIAM KANA_MSG_DIAM_E2);    
  }
  return PSTR(MSG_FILAMENT_DIAM MSG_DIAM_E2);
}
...
static const char* msg_filament_diam_diam_e3() {
  switch (currentfontnameindex) {
    ...
    case 1:
      return PSTR(CN_MSG_FILAMENT_DIAM CN_MSG_DIAM_E3);
    case 2:
      return PSTR(KANA_MSG_FILAMENT_DIAM KANA_MSG_DIAM_E3);    
  }
  return PSTR(MSG_FILAMENT_DIAM MSG_DIAM_E3);
}
...
static const char* msg_filament_diam_diam_e4() {
  switch (currentfontnameindex) {
    ...
    case 1:
      return PSTR(CN_MSG_FILAMENT_DIAM CN_MSG_DIAM_E4);
    case 2:
      return PSTR(KANA_MSG_FILAMENT_DIAM KANA_MSG_DIAM_E4);    
  }
  return PSTR(MSG_FILAMENT_DIAM MSG_DIAM_E4);
}
/* MSG_CONTRAST */
...
/* MSG_FILAMENTCHANGE */
static const char* msg_filamentchange1() 
{
  switch (currentfontnameindex) 
  {
    case 0:
      return PSTR(MSG_FILAMENTCHANGE MSG_DIAM_E1);
    case 1:
      return PSTR(CN_MSG_FILAMENTCHANGE CN_MSG_DIAM_E1);
    case 2:
      return PSTR(KANA_MSG_FILAMENTCHANGE KANA_MSG_DIAM_E1);    
  }
  return PSTR(MSG_FILAMENTCHANGE MSG_DIAM_E1);
}

/* MSG_FILAMENTCHANGE */
static const char* msg_filamentchange2() 
{
  switch (currentfontnameindex) 
  {
    case 0:
      return PSTR(MSG_FILAMENTCHANGE MSG_DIAM_E2);
    case 1:
      return PSTR(CN_MSG_FILAMENTCHANGE CN_MSG_DIAM_E2);
    case 2:
      return PSTR(KANA_MSG_FILAMENTCHANGE KANA_MSG_DIAM_E2);    
  }
  return PSTR(MSG_FILAMENTCHANGE MSG_DIAM_E2);
}
